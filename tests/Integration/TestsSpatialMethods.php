...
trait TestsSpatialMethods
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\AngelSourceLabs\LaravelSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
...
//        }
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\AngelSourceLabs\LaravelSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \AngelSourceLabs\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \AngelSourceLabs\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \AngelSourceLabs\LaravelSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
